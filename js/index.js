...
function elaborarOfc()
{
    ...
    if ($("#rgPessoa").val().length != 0 && $("#nomePessoa").val().length != 0 && $("#motivoConvoc").val().length != 0 && $("#respPrisao").val() != "") 
    {
        ...
        $("#assinaturaResp").text($("#respPrisao").val())
        $(".navbar").hide();
        $("#p1").append(`Eu, <b>${$("#cargoPessoa").val().toUpperCase()}</b> da academia de polícia <b>${$("#nomePessoa").val().toUpperCase()}</b> portador(a) do <b>RG</b> de Nº<b>${$("#rgPessoa").val().toUpperCase()}</b> no uso de minhas atribuições, decido por: \nDesligar de suas funções exercidas na academia de policia o atual <b>${$("#cargoPunido").val().toUpperCase()}</b> <b>${$("#motivoConvoc").val().toUpperCase()}</b>\n portador do RG de Nº <b>${$("#idPunido").val().toUpperCase()}</b> das funções <b>${$("#solicitacaoR").val().toUpperCase()}</b>, \nAgradecemos seus serviços em prol a academia.`)
        $("#p2").append(' ')
...
function elaborarAtribuicao()
{
    ...
    if ($("#rgPessoa").val().length != 0 && $("#nomePessoa").val().length != 0 && $("#motivoConvoc").val().length != 0 && $("#respPrisao").val() != "") 
    {
        ...
        $("#assinaturaResp").text($("#respPrisao").val())
        $(".navbar").hide();
        $("#p1").append(`Eu, <b>${$("#cargoPessoa").val().toUpperCase()}</b> da academia de polícia <b>${$("#nomePessoa").val().toUpperCase()}</b> portador(a) do <b>RG</b> de Nº<b>${$("#rgPessoa").val().toUpperCase()}</b> no uso de minhas atribuições, decido por: \nAtribuir o Sr.(a) <b>${$("#motivoConvoc").val().toUpperCase()}</b> \n portador do RG de Nº <b>${$("#idPunido").val().toUpperCase()}</b> atual <b>${$("#cargoPunido").val().toUpperCase()}</b> do Departamento de Polícia do Destiny, para funções de <b>${$("#funcaoAtual").val().toUpperCase()}</b> da Academia De Policia, com atribuições de auxiliar e promover as necessidades do setor.`)
        $("#p2").append(' ')
        $("#dataAtual").append('Destiny, '+str_data)
        html2canvas(document.getElementById("container"), {
            allowTaint: true,
